...
//import vn.kalapa.ekyc.utils.Utils;
//
//
///**
...
// */
//public class CardClassifier implements Classifier {
//
...
//     */
//    public static CardClassifier create(
...
//            final int[] anchors*/)
//            throws IOException {
//        final CardClassifier d = new CardClassifier();
//        String actualFilename = "klp_label.txt";
...
////        Helpers.Companion.printLog("Bitmap: " + bitmap.getWidth() + " height : " + bitmap.getHeight() + "- " + bitmap.getByteCount()) ;
...
//            if ((numClass == 2 && detectedClass == 1 && confidenceInClass > getObjThresh()) || (numClass == 2 && detectedClass == 0 && confidenceInClass > getObjThresh() + 0.2) || (numClass != 2 && confidenceInClass > getObjThresh())) {
...
////        Log.d("YoloV5Classifier", "Time Exceed: " + (System.currentTimeMillis() - start));
//        return recognitions;
//    }
//
